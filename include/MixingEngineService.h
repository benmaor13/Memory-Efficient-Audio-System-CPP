...
public:
    MixingEngineService();
    ~MixingEngineService();
    MixingEngineService(const MixingEngineService&) = delete; //disabling copy constructor
    MixingEngineService& operator=(const MixingEngineService&) = delete; //disabling copy assignment
